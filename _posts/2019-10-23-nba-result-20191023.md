...
![LAC_LAL_win.png](../images/nba/result/LAC_LAL_win.png)
...
<table class="tg">
  ...
  <tr>
    <td class="tg-dcpn">MontrezlHarre(17)<br>KawhiLeonardF(30)<br>LouWilliams(21)</td>
...
#### <span style="color:red"> 토론토(홈) VS 뉴올리언스(원정) </span>
![TOR_NOP_win.png](../images/nba/result/TOR_NOP_win.png)
...
<table class="tg">
  ...
  <tr>
    ...
    <td class="tg-rr9t">주요 득점선수</td>
    <td class="tg-dcpn">JoshHart(15)<br>JJRedickG(16)<br>BrandonIngram(22)</td>
  </tr>
</table>
...
#nba #미국농구 #엔비에이 #농구분석 #토토 #스포츠토토 #경기예측 #농구결과 #20191023 #LA클리퍼스 #LA레이커스 #토론토 #뉴올리언스 #LA클리퍼스LA레이커스 #토론토뉴올리언스 